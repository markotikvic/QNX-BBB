...
extern int init_ds1339c(struct chip_loc *chip, char *argv[]);
extern int get_ds1339c(struct tm *tm, int cent_reg);
extern int set_ds1339c(struct tm *tm, int cent_reg);

extern int init_rtc8564(struct chip_loc *chip, char *argv[]);
extern int get_rtc8564(struct tm *tm, int cent_reg);
extern int set_rtc8564(struct tm *tm, int cent_reg);
#endif
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/utils/r/rtc/rtc.h $ $Rev: 754053 $")
#endif
