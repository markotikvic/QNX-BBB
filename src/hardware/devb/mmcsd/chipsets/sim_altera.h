...
/*
 * Field : External open-drain pullup:
 *
 ...
 *  Enum                                   | Value | Description
 * :---------------------------------------|:------|:--------------------------------------------
 *  ALT_SDMMC_CTL_ENABLE_OD_PULLUP_DISD    | 0x0   | External open-drain pullup disabled
 * :                                       |       |
 *  ALT_SDMMC_CTL_ENABLE_OD_PULLUP_END     | 0x1   | External open-drain pullup enabled
 *
 */
/*
 * Enumerated value for register field ALT_SDMMC_CTL_ENABLE_OD_PULLUP_DISD
 *
 * External open-drain pullup disabled
 */
#define ALT_SDMMC_CTL_ENABLE_OD_PULLUP_DISD  0x0
/*
 * Enumerated value for register field ALT_SDMMC_CTL_ENABLE_OD_PULLUP_END
 *
 * External open-drain pullup enabled
 */
#define ALT_SDMMC_CTL_ENABLE_OD_PULLUP_END   0x1

/* The Least Significant Bit (LSB) position of the ALT_SDMMC_CTL_ENABLE_OD_PULLUP register field. */
#define ALT_SDMMC_CTL_ENABLE_OD_PULLUP_LSB        24
/* The Most Significant Bit (MSB) position of the ALT_SDMMC_CTL_ENABLE_OD_PULLUP register field. */
#define ALT_SDMMC_CTL_ENABLE_OD_PULLUP_MSB        24
/* The width in bits of the ALT_SDMMC_CTL_ENABLE_OD_PULLUP register field. */
#define ALT_SDMMC_CTL_ENABLE_OD_PULLUP_WIDTH      1
/* The mask used to set the ALT_SDMMC_CTL_ENABLE_OD_PULLUP register field value. */
#define ALT_SDMMC_CTL_ENABLE_OD_PULLUP_SET_MSK    0x01000000
/* The mask used to clear the ALT_SDMMC_CTL_ENABLE_OD_PULLUP register field value. */
#define ALT_SDMMC_CTL_ENABLE_OD_PULLUP_CLR_MSK    0xfeffffff
/* The reset value of the ALT_SDMMC_CTL_ENABLE_OD_PULLUP register field. */
#define ALT_SDMMC_CTL_ENABLE_OD_PULLUP_RESET      0x0
/* Extracts the ALT_SDMMC_CTL_ENABLE_OD_PULLUP field value from a register. */
#define ALT_SDMMC_CTL_ENABLE_OD_PULLUP_GET(value) (((value) & 0x01000000) >> 24)
/* Produces a ALT_SDMMC_CTL_ENABLE_OD_PULLUP register field value suitable for setting the register. */
#define ALT_SDMMC_CTL_ENABLE_OD_PULLUP_SET(value) (((value) << 24) & 0x01000000)
...
typedef	struct _socfpga_mmc {
	unsigned		mmc_pbase;		// physical address of the mmc controller       sourse cfg->IOPort_Base[0]
	uint32_t		mmc_clock;		// ??? controller source clock ???        100000000       ??? 96000000

	uintptr_t		mmc_base;		// virtual address of the mmc controller

	int				mmc;

	// Flags for data transfer
	uint32_t		dcmd;					// some other bits, which will be ored with other bits sent to CMD register (0x2C)
											// in socfpga_setup_pio():   ALT_SDMMC_CMD_DATA_EXPECTED_SET_MSK
	uint32_t		dmask;					// value, which will be used for Interrupt Mask Register for commands, which dont expect data
	int				dsize;

	// Flags for clock enable and data time out
	uint32_t		dtoc;

	uintptr_t		dma_base;	// virtual address of the DMA controller
...
extern int	socfpga_attach(SIM_HBA *hba);
extern int socfpga_dma_continue(SIM_HBA *hba, paddr_t paddr, int len, int dir);
