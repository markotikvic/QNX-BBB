...
#ifndef _OMAP5_DPLL_INIT_H_
#define _OMAP5_DPLL_INIT_H_
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/startup/lib/public/arm/omap5_dpll_init.h $ $Rev: 736898 $")
#endif
