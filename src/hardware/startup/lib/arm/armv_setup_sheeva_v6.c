...
void
armv_setup_sheeva_v6(struct cpuinfo_entry *cpu, unsigned cpuid)
{
	...
	/*
	 * Check for iWMMX2 unit (VFP is detected in armv_setup_v6)
	 */
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/startup/lib/arm/armv_setup_sheeva_v6.c $ $Rev: 680332 $")
#endif
