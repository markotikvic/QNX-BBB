 ...
 */
const struct armv_chip armv_chip_a15_32 = {
	.cpuid		= 0xc0f0,
	.name		= "Cortex A15",
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/startup/lib/arm/armv_chip_a15.c $ $Rev: 759590 $")
#endif
