...
calloc_ram(size_t size, unsigned align) {
	...
	a = (paddr32_t)alloc_ram(NULL_PADDR, size, align);

	// If a secure system, we can assume alloc_ram has inited the memory
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/startup/lib/ram.c $ $Rev: 759590 $")
#endif
