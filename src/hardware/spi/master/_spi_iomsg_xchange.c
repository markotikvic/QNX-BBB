...
int
_spi_iomsg_xchange(resmgr_context_t *ctp, io_msg_t *msg, spi_ocb_t *ocb)
{
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/spi/master/_spi_iomsg_xchange.c $ $Rev: 680332 $")
#endif
