...
#ifndef _USB_NCM_DESCRIPTORS_H_INCLUDED
#define _USB_NCM_DESCRIPTORS_H_INCLUDED
...
#define USBDC_PROTOCOL_NAME 		"CDCNCM"
...
#define SIZE_CONFIG_DESC			(86 + SIZE_IAD)
...
/* NCM Communication Interface descriptor */
	0x09,					/* bLength						*/
...
/* USB Communication Class Ethernet Networking Functional Descriptor */
	...
	0x00,
	0x00,
	(NCM_SEG_LEN & 0xff),		/* wMaxSegmentSize Low		*/
	((NCM_SEG_LEN >> 8) & 0xff),/* wMaxSegmentSize High		*/
...
/* NCM Functional Descriptor */
	0x06,					/* bLength						*/
	0x24,					/* CS_INTERFACE					*/
	0x1A,					/* bDescriptorSubtype: NCM Functional Descriptor */
	0x00,					/* bcdNcmVersion - low byte		*/
	0x01,					/* bcdNcmVersion - high byte	*/
...
/* DATA interface descriptor ... alternate 0 */
	...
	0x01,					/* nInterfaceProtocol: Network Transfer Block	*/
	0x07,					/* iInterface					*/
...
static const char *usbdc_string_descriptor[] = {
		...
		&string_descriptors[4 + 42 + 46 + 30 + 44 + 28 + 66],
		&string_descriptors[4 + 42 + 46 + 30 + 44 + 28 + 66 + 34],
};
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/devu/dc/private/hw/usbdc_desc_ncm.h $ $Rev: 736722 $")
#endif
