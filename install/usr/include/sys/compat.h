...
#pragma pack()
    ...
    */
	...
	extern int     file_has_acl(const char* name, const struct stat *sbuf);
...
/* Common to all non-neutrino hosts */
#ifndef __QNXNTO__
/* From sys/neutrino.h: */
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/lib/compat/public/lib/compat.h $ $Rev: 736886 $")
#endif
